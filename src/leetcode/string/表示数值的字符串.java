...
public class 表示数值的字符串 {
    ...
    //状态机写法 https://leetcode-cn.com/problems/biao-shi-shu-zhi-de-zi-fu-chuan-lcof/solution/mian-shi-ti-20-biao-shi-shu-zhi-de-zi-fu-chuan-y-2/
    public boolean isNumberSecond(String s) {
        HashMap[] states = {
